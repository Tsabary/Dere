...
class ProfileSecondRandomUserFragment : Fragment(), DereMethods {

    private lateinit var sharedViewModelSecondImage: SharedViewModelSecondImage
    private lateinit var sharedViewModelForRandomUser: SharedViewModelSecondRandomUser
    ...
    override fun onAttach(context: Context) {
        ...
        activity?.let {
            ...
            sharedViewModelForRandomUser = ViewModelProviders.of(it).get(SharedViewModelSecondRandomUser::class.java)
