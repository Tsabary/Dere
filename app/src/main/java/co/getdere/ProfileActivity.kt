...
//        sharedViewModelRandomUser.randomUserObject.postValue(Users())
        ...
        navHostFragment = profile_nav_host_fragment
        ...
        mBottomNav = findViewById(co.getdere.R.id.profile_bottom_nav)
        mBottomNav.selectedItemId = R.id.destination_profile_logged_in_user
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        val navController = Navigation.findNavController(this, R.id.profile_nav_host_fragment)
    ...
    private fun setupNavController() {
        ...
        val graph = inflater.inflate(R.navigation.current_user_profile_nav_graph)
        myNavHostFragment.navController.graph = graph


        val navController = Navigation.findNavController(this, R.id.profile_nav_host_fragment)
//        setupBottomNavMenu(navController)
        this.findNavController(R.id.profile_nav_host_fragment)
    }
